  ...
  return (
    <section className="relative bg-white pt-6 md:pt-8 pb-0">
      ...
      >
         ...
         *     `left: calc(50% + 240px)`
         *   That puts the wave's LEFT edge 240 px right of centre =
         *   a full 100 px inside the hero's right edge (340 − 240).
         *   So the whole leading section of the wave slips visibly
         *   BEHIND the right defender — clearly emerging from behind
         *   his body rather than floating next to it — while the
         *   remaining ~320 px streams off toward the viewport's
         *   right edge (and beyond, safely clipped by
         *   `.hero-deco-clip`).
         *
         ...
         *     `right: calc(50% + 240px)`
         *   which places the wave's RIGHT edge 240 px left of centre
         *   = 100 px inside the hero's left edge. A generous slice
         *   of the wave slips behind the left defender, so the
         *   viewer clearly reads it as "coming out from behind him";
         *   the rest streams off toward the viewport's left edge
         *   (and beyond, clipped).
         *
