 ...
 * تا کارت به‌عنوان مُهرِ اعتمادِ صفحه از بدنه جدا و برجسته شود. به‌درخواستِ
 * محصول، زیر نماد هیچ نوشتهٔ اضافه‌ای (چیپ/کپشن) وجود ندارد — همین یک
 * کارتِ تمیز کافی است و ارتفاعِ فوتر فشرده می‌ماند. className از بیرون
 * تزریق می‌شود تا تصمیم‌های چیدمانیِ ردیف (ترتیب، مارجین) مالکیتش دست
 * فوتر بماند.
 */
export function TrustSeals({ className = '' }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      {/* پایهٔ نور — هالهٔ برندیِ نرم دور کارت نماد */}
